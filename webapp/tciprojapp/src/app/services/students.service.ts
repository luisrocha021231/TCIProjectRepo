...
private URL_API = 'http://localhost:9090/api/students';
  ...
  getStudentById(id : number){
    ...
    return this.http.get<Student>(this.URL_API + '/'+id); //get('http://localhost:9090/api/students/${id}')
  }
  ...
  getStudentToNameOrLastname(filtro: string){
    return this.http.get<Student[]>(this.URL_API+'/search?filtro='+filtro);
  }
